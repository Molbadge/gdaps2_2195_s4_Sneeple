...
namespace Schwartz_s_Sneaky_Snail_Mail_Scandal
{
    ...
    public class Game1 : Game
    {
		...
		/// <summary>
		/// Adds tiles to worldMap using file data generated by the level editor.
		/// </summary>
		/// <param name="directory">
		/// The save location of the file generated by the level editor.
		/// </param>
		/// <param name="mapSheet">
        ...
        {
			// Initialising map using a preset file in the file directory
			currentRoomDirectory = "../../../../Content/igmHallway";
        ...
        protected override void Draw(GameTime gameTime)
        {
			...
			#region Draw portion for Room FSM
			switch (currentRoom)
			{
				case (Rooms.Hallway):
					{
				...
				case (Rooms.Office):
					{
						currentRoomDirectory = "../../../../Content/igmOffice";
